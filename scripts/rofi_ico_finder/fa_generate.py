...
if __name__ == "__main__":
    mypath = "/one/dev/src/Rofi-Ico-Finder"  # change this line
    # taken from there : https://raw.githubusercontent.com/FortAwesome/Font-Awesome/master/src/icons.yml
    yaml_filepath = path.join(mypath, "fa_icons.yml")
