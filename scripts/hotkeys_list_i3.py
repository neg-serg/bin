...
# initial version taken from: https://gist.github.com/maledorak/488c1bd0a6cca333c32c5289b841b9ef
...
class DmenuHotKeys(object):
    ...
    2. Run this script with your app arg (i3)
    `./dmenu_hotkeys.py i3`
    """
